...
public class Game extends JFrame{
    ...
    JButton startguess = new JButton("Start guessing");
    ...
    String str="";
    public Game(){ // the main frame of the game
        ...
        start.setText("Please start guessing");
    ...
    private class ActLis implements ActionListener { //the action listener part of guessing number
